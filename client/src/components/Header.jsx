...
function Header() {
   return (      
         <div className="flex flex-col justify-center items-center w-screen">
            ...
            <div className="z-20 flex flex-row justify-between items-center w-[100vw] max-h-[15vh]">
               <img src="src\assets\topLeftIcon.png" className="w-[20vw] h-[10vh] min-w-[20vw]" />
               <img src="src\assets\centreIcon.png" className="w-[20vw] h-[10vh] min-w-[20vw]" />
               <img src="src\assets\topRightIcon.png" className="w-[20vw] h-[10vh] min-w-[20vw]" />
            </div>

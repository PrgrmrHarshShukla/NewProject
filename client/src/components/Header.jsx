         ...
         <div className="flex flex-col justify-between items-center w-[20vw] fixed border-gray-300 rounded-tr-[60px] overflow-y-hidden mb-0 h-[100vh]">
               ...
               <ul className="z-0 flex flex-col justify-center items-start w-[20vw] h-[82vh] min-h-[82vh] bg-gray-300 text-[1.3rem] overflow-x-hidden border rounded-[10px]">
                  ...
                  <li title="Profile" className="h-[100%] w-[100%] flex flex-col justify-center items-start font-semibold text-black">
                     <Link className="text-black no-underline flex flex-row justify-start items-center gap-7 sm:gap-3 -ml-4 sm:ml-12" to="/profile">
                  ...
                  <li title="Widgets" className="h-[100%] w-[100%] flex flex-col justify-center items-start font-semibold text-black">
                     <Link className="text-black no-underline flex flex-row justify-start items-center gap-8 sm:gap-3 -ml-4 sm:ml-12" to="/formIntro">
                  ...
                  <li title="Services" className="h-[100%] w-[100%] flex flex-col justify-center items-start font-semibold text-black">
                     <Link className="text-black no-underline flex flex-row justify-start items-center gap-7 sm:gap-3 -ml-4 sm:ml-12" to="/services">
                  ...
                  <li title="Registration" className="h-[100%] w-[100%] flex flex-col justify-center items-start font-semibold text-black">
                     <Link className="text-black no-underline flex flex-row justify-start items-center gap-7 sm:gap-3 -ml-4 sm:ml-12" to="/registration">
                  ...
                  <li title="Contact" className="h-[100%] w-[100%] flex flex-col justify-center items-start font-semibold text-black">
                     <Link className="text-black no-underline flex flex-row justify-start items-center gap-7 sm:gap-3 -ml-4 sm:ml-12" to="/contact">
                  ...
                  <li title="Logout" className="h-[100%] w-[100%] flex flex-col justify-center items-start font-semibold text-black">
                        <button 
                        onClick={handleClick}
                           className="text-black no-underline flex flex-row justify-start items-center gap-7 sm:gap-3 -ml-4 sm:ml-12 hover:cursor-pointer"
                        >

   ...
   <div className="w-[80vw] mx-[10vw] h-auto">
      ...
      <div  className="m-4 pt-0 p-8 overflow-x-hidden overflow-y-auto  text-[12px] ">
         ...
         तहसील कार्यालय, अंबड<br />
            मी  <input value={name} onChange={(e) => setName(e.target.value)} className="text-center text-blue-500" type="text" />   या जातीचा/जातीची असून हि जात /जमात केंद्र शासन, मिनिस्ट्री ऑफ पर्सोनल, पब्लिक ग्रीवेन्सेस अँड पेन्शन्स डिपार्टमेन्ट ऑफ पर्सोनल अँड ट्रेनिंग कार्यालयीन - ज्ञापन क्रमांक - ३६०१२/२२/९३- इएसटीटी (एस.सी.टी.)दि.०८सप्टेंबर,१९९३ अन्वये सुधारित केल्याप्रमाणे तसेच केंद्र शासनाने आणि राज्यशासनाने यासंदर्भात वेळोवेळी निर्गमित केलेल्या सूचने (Notification) नुसार शासन निर्णयानुसार शासनसेवेतील आरक्षणाच्या लाभाकरिता इतर मागासवर्ग प्रवर्गात गणल्या जाते. सदर जात / जमात राज्य शासनाने विहितकेलेल्या मागासवर्गीयाच्या यादीमधील  <input className="text-center text-blue-500" type="text" />  या प्रवर्गात मोडतो / मोडते. <br />
         ...
         <div className="border-2 border-black px-4 py-1 rounded-[10px] mt-2 mb-2">
            ...
            मी <input type="text" value={name}  className="text-center text-blue-500" />  श्री <input type="text" className="text-center text-blue-500" />  यांचा/यांची मुलगी/मुलगा/पत्नी वय <input type="text" className="text-center w-8 text-blue-500" />  वर्ष, व्यवसाय <input type="text" className="text-center text-blue-500" /> रा <input type="text" className="text-center text-blue-500" /> ता. <input type="text" className="text-center text-blue-500" /> जि.जालना याद्वारे घोषित करते की ,वरील सर्व माहिती माझ्या व्यक्तिगत माहिती व समजुती नुसार खरी आहे.सदर माहिती खोटी आढळून आल्यास , भारतीय दंड सहिता अन्वये / किवा संबधित कायद्यानुसार माझ्यावर खटला भरला जाईल व त्यानुसार मि शिक्षेस पात्र राहीन याची मला पूर्ण जाणीव आहे.
